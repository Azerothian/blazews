...
using NHibernate;
using Illisian.Nhibernate.Membership.Util;
...
using Illisian.Nhibernate.Membership.EntityLogic;

namespace Illisian.Nhibernate.Membership
{
	...
	public sealed class NHibernateMembershipProvider : MembershipProvider
	{
		...
		//private Illisian.Nhibernate.Membership.Managers.ApplicationManager _applicationManager;
		...
		public override void Initialize(string name, NameValueCollection config)
		{
			...
			using (var session = Database.Context.GetSession())
			{
